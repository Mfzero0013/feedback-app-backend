...
router.get('/users', requirePermission(['ADMINISTRADOR', 'GESTOR']), adminController.getAllUsers);
...
router.get('/teams', requirePermission('ADMINISTRADOR'), adminController.getAllTeams);
